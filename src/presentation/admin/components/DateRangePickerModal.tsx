    ...
    <Modal transparent animationType="fade" onRequestClose={onClose}>
      ...
      >
        <Pressable
          ...
          style={{
            backgroundColor: colors.cardDark, borderRadius: 20,
        ...
        >
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            ...
            <Pressable
              onPress={() => { if (canGoNext) setViewMonth((d) => new Date(d.getFullYear(), d.getMonth() + 1, 1)); }}
                ...
                return (
                  <Pressable
                    ...
                    style={{
                      ...
                      borderRadius: isSelected ? 9999 : inRange ? 0 : 9999,
                      backgroundColor: isSelected ? colors.neonPurple : inRange ? `${colors.neonPurple}30` : 'transparent',
                    }}
                  >
                    <AppText style={{
                      fontSize: 13,
                      fontWeight: isSelected ? '700' : '400',
                      color: isSelected ? colors.white : inRange ? colors.neonPurple : colors.textSlate200,
                    }}>
                      {day}
                    </AppText>
                  </Pressable>
          ...
          <View style={{ flexDirection: 'row', gap: 10, marginTop: 14 }}>
            ...
            <Pressable
              onPress={() => rangeStart && onConfirm({ start: rangeStart, end: rangeEnd ?? rangeStart })}
              accessibilityRole="button" accessibilityLabel="Confirm"
              style={{
                flex: 1, paddingVertical: 12, borderRadius: 9999, alignItems: 'center',
                backgroundColor: rangeStart ? colors.neonPurple : colors.borderDark,
