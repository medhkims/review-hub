...
const ConversationCard = React.memo(({ conversation, onPress }: ConversationCardProps) => {
  ...
  return (
    <Pressable
      ...
      accessibilityLabel={`Business conversation: ${conversation.lastMessage}`}
    ...
    >
      ...
      >
        <MaterialCommunityIcons name="domain" size={24} color={colors.neonPurple} />
      </View>
      ...
      <View className="flex-1 ml-3 min-w-0">
        <View className="flex-row items-center justify-between">
          <AppText
            ...
            numberOfLines={1}
          >
            {`Business ${conversation.id.slice(0, 6)}`}
          </AppText>
          <AppText
...
const EmptyState = () => (
  <View className="flex-1 items-center justify-center px-8 py-16">
    <MaterialCommunityIcons name="domain" size={64} color={colors.borderDark} />
    <AppText
    ...
    >
      Business owner conversations will appear here
    </AppText>
  </View>
);

// ---- AdminBusinessChatScreen ------------------------------------------------

export default function AdminBusinessChatScreen() {
  const router = useRouter();
  const { conversations, isLoading, error, refresh } = useAdminConversations('business');
    ...
    <ScreenLayout>
      ...
      >
        ...
        <View
          ...
          style={{ backgroundColor: colors.cardDark, borderWidth: 1, borderColor: colors.neonPurple }}
        >
          <MaterialCommunityIcons name="domain" size={18} color={colors.neonPurple} />
        </View>
